...
import com.acwilliam.springboot.wrapper.PageableResponse;
...
class AnimeControllerIT {
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(CriarAnime.CriarAnimeParaSerSalvo());
    ...
    void save_ReturnsAnime_WhenSuccessful(){
        AnimePostRequestBody animePostRequestBody = AnimePostRequestBodyCreator.CriarAnimePostRequestBody();
